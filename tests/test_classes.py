from src.Rectangle import Rectangle as Rect, Square as Sq
from src.Circle import Circle as Cir
...
def test_negative_sum_areas(side_a, side_b, side_c, tri_cir):
    with pytest.raises(ValueError):
        ...
        cir1 = Cir(side_c)
        cir1.get_figure_area()
        assert cir1.sum_areas(tri1) == pytest.approx(tri_cir, 0.0099)
